...
newPlotGeneric(type="barplot",plotName="Afiliacion",dataset=cuest[,16:20],isRGB=TRUE,isDownload=TRUE,addLegend=TRUE,cond1=cuest[,4],cond2=cuest[,5],cond1Label="DPT",cond2Label="MUN")


### how to keep output with list of all sub-selection like in this old deprecated code... TO DO
